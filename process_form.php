...
<head>
    <meta charset="utf-8">
    <title>Forever - Pet Care Website </title>
        ...
        <div class="row py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-capitalize"><span class="text-primary">For</span>ever</h1>
                </a>
            </div>
            <div class="col-lg-8 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="d-inline-flex flex-column text-center px-3 border-right">
                        <h6>Email Us</h6>
                        <p class="m-0">Forever69@gmail.com</p>
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mail($to, $subject, $message, $headers)) {
        echo "Thank you for your reservation request. We will get in touch with you shortly.";
    } else {
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="bg-primary py-5 px-4 px-sm-5">
                        <form class="py-5" action="https://formsubmit.co/alaktimke@gmail.com" method="POST" >
                            ...
                            <div class="form-group">
                                <div class="time" id="time" data-target-input="nearest">
                                    <input type="text" name="Reservation Time" class="form-control border-0 p-4 datetimepicker-input" placeholder="Reservation Time" data-target="#time" data-toggle="datetimepicker"/>
                                </div>
                            </div>
                            <div class="form-group">
